		...
		<div class="container">
			...
			<div class="row top_header pt-3">
				...
				<div class="col-lg-2 col-md-4 col-sm-4 col-5 top-grid pl-0">
					...
					<p class="">
						+1 206 307 8888 <span class="block">24/7 Helpline</span>
					</p>
				</div>
			</div>
			<!-- top header -->
			...
			<div class="choose text-center position-absolute d-lg-flex">
				<div class="choose-icon">
					...
					<div class=" choose-grid">
						<h3 class="mt-4">
							<a
								href="<%=request.getContextPath()%>/studentList.do?teacherId=<%=teacherId%>"
								target="view_window">Student Info</a>
						</h3>
				...
				<div class="choose-icon">
					...
					<div class="choose-grid">
						<h3 class="mt-4">
							<a href="<%=request.getContextPath()%>/teacherList.do"
								target="view_window">Teacher Info</a>
						</h3>
				...
				<div class="choose-icon">
					...
					<div class="choose-grid">
						<h3 class="mt-4">
							<a
								href="<%=request.getContextPath()%>/immuStudentList.do?teacherId=<%=teacherId%>"
								target="view_window">Vaccine Info</a>
						</h3>
				...
				<div class="choose-icon">
					...
					<div class="choose-grid">
						<h3 class="mt-4">
							<a href="<%=request.getContextPath()%>/NewAddStudent.jsp"
								target="view_window">Register Info</a>
						</h3>
				...
				<div class="choose-icon mr-0">
					...
					<div class="choose-grid">
						<h3 class="mt-4">
							<a href="index.do" target="view_window">HOME</a>
						</h3>
						<p class="">Our Story</p>
					</div>
				</div>
			...
			<div class="row about-grids">
				...
				<table class="table">
					<tr class="table_header">
						<td><a href="studentList.do?teacherId=<%=teacherId%>">Student
								ID</a></td>
						<td>Name</td>
						<td><a href="sortAge.do?teacherId=<%=teacherId%>">Age</a></td>
						<td>Parent's Name</td>
						<td>Address</td>
						<td>Phone Number</td>
						<td>Teacher ID</td>
				...
				<p>
					...
					<%
						if (teacherId == 0) {
					%>
					<input type="button" class="button" value="Assign Teacher"
						onclick="location='<%=request.getContextPath()%>/assignTeacher.do'" />
					<input type="button" class="button" value="Reset Teacher"
						onclick="location='<%=request.getContextPath()%>/resetTeacherId.do'" />
					<%
						}
					%>
		...
		<div class="container">
			<div class="row footer-top-grid">
				...
				<div class="col-sm-6 text-sm-right mt-sm-0 mt-3">
					<h3>
						<span class="fa fa-phone" aria-hidden="true"></span> +1 206 307
						8888
					</h3>
				</div>
			</div>
