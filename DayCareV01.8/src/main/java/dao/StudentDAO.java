...
public class StudentDAO {
	...
	public void updateVaccine(Student student) throws Exception {
		  ...
		  try {
		   ...
		   stat.setString(2, student.getDtap6());
		   stat.setString(3, student.getDtap15());
		   stat.setString(4, student.getPolio6());
		   stat.setString(5, student.getPolio15());
